// github.com/lafelabs/openarduino/finalprojects/lafe
...
int deltat = 40;//time between frames in ms
int blinktime = 250;
...
//cycle red the other way
  for(int i=7; i >=0; i--) { // For each pixel in strip...
    strip.setPixelColor(i, color);         //  Set pixel's color (in RAM)
    strip.show();                          //  Update strip to match
    delay(deltat);
    strip.setPixelColor(i, strip.Color(0,0,0));         //  Set pixel's color (in RAM) 
...
//turn on two eyes red, blink, and stay on

    strip.setPixelColor(0, color);         //  Set pixel's color (in RAM)
    strip.setPixelColor(7, color);         //  Set pixel's color (in RAM)
    strip.show();                          //  Update strip to match
    delay(blinktime);
