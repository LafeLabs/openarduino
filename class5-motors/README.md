...
This week we will learn Trash Robot.  Learn to drive stepper motors, learn how robotics works, take the code apart and put it back together, break into 4 groups of either 2 or 3, take a robot, get it working, then each group makes their own new program.  It can be very simple! Back and forth, up and down, in a square, etc.  Automation is just repeated action.

trash robot clay printer with dual stages for joint movement for x and z motion:
...
this is the independent motion used for any other x, y, z movements:
